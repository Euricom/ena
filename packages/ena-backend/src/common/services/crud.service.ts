...
import { IUpdateCrudInput } from '../interfaces/inputs/updateCrud.input';
import { PaginationResultClass } from '../models/pagination.model';
import { PaginationInput } from '../models/inputs/pagination.input';

@Injectable()
export class CrudService<T extends ICrud, C, U extends IUpdateCrudInput> {
